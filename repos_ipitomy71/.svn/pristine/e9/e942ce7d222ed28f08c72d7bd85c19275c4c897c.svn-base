...
<tr>
	...
	{*{if $header eq 'Address Information'}*}
							...
							<div style="float:left;font-weight:bold;"><div style="float:left;"><a href="javascript:showHideDetailViewVTCallQuotesWO('dtlViewWO{$quoteid}','imgWO{$quoteid}');">
							{if $OPEN_BY_DEFAULT neq 'Quote/WO Information'}
								<img id="imgWO{$quoteid}" src="{'inactivate.gif'|@vtiger_imageurl:$THEME}" style="border: 0px solid #000000;" alt="Display" title="Display"/>
							{elseif $BLOCKINITIALSTATUS[$header] eq 1}
								<img id="imgWO{$quoteid}" src="{'activate.gif'|@vtiger_imageurl:$THEME}" style="border: 0px solid #000000;" alt="Hide" title="Hide"/>
							{else}
								<img id="imgWO{$quoteid}" src="{'inactivate.gif'|@vtiger_imageurl:$THEME}" style="border: 0px solid #000000;" alt="Display" title="Display"/>
							{/if}
								</a></div><b>&nbsp;
...
{*{if $header eq 'Address Information'}*}
							...
							{/if}
						<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small" id="dtlViewWO{$quoteid}" {if $OPEN_BY_DEFAULT neq 'Quote/WO Information'}style="display:none"{/if}>
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"> <a href="javascript:showHideDetailViewQuotesContacts('{$RELCONTACT}','{$EVENTID}','{$quoteid}','MultiAddress','relQCon{$EVENTID}','imgQCon{$EVENTID}','divQCon{$EVENTID}')">
                                                                        <img style="border:0px;" id="imgQCon{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                  ...
                                  <tr id="relQCon{$EVENTID}" bgcolor=white style=" display:none ">
                                    <td colspan="20">
                                        <div id="divQCon{$EVENTID}">
                                        </div>
                                    </td>                   
                                  </tr>
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a onclick="javascript:showHideDetailViewActivitiesList('activitydetailsQ{$EVENTID}','imgqa{$EVENTID}','{$EVENTID}','{$quoteid}','divqa{$EVENTID}','{$DATEFORMAT_VTCALL}')" name="{$EVENTID}" href="#{$EVENTID}"><img style="border:0px;" id="imgqa{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                  ...
                                  <tr id="activitydetailsQ{$EVENTID}" bgcolor=white style=" display:none ">
                                    <td colspan="20">
                                        <div id="divqa{$EVENTID}">
                                        </div>
                                    </td>                   
                                  </tr>
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewActivityHistory('qActhistory{$EVENTID}','imgcah{$EVENTID}','{$EVENTID}','{$quoteid}','qdiveh{$EVENTID}','MultiAddress')">
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewEmailHistory('emailhistory{$EVENTID}','imgeh{$EVENTID}','{$EVENTID}','{$quoteid}','diveh{$EVENTID}','MultiAddress')"><img style="border:0px;" id="imgeh{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                        ...
                                        <td colspan=4 class="dvInnerHeader4">
                                                <div style="float:left;font-weight:bold">
                                                        <div style="float:left">
                                                                <a href="javascript:showHideDetailViewQuotesRelatedList('relQuote{$EVENTID}','imgq{$EVENTID}','{$EVENTID}','{$contactid}','divq{$EVENTID}','MultiAddress')">
							...
							{if $related_wos eq 1}
			                    <tr>{strip}
			                        <td colspan=4 class="dvInnerHeader4">
			                                <div style="float:left;font-weight:bold">
			                                        <div style="float:left">
			                                                <a href="javascript:showHideDetailViewSORelatedList('relSO{$EVENTID}','imgSO{$EVENTID}','{$EVENTID}','{$contactid}','divSO{$EVENTID}','MultiAddress')">
							...
							{if $related_doc eq 1}
			                    <tr>{strip}
			                        <td colspan=4 class="dvInnerHeader4">
			                                <div style="float:left;font-weight:bold">
			                                        <div style="float:left">
			                                                <a href="javascript:showHideDetailViewDocumentsRelatedList('reldoc{$EVENTID}','imgdoc{$EVENTID}','{$EVENTID}','{$contactid}','divdoc{$EVENTID}','MultiAddress')">
			                                                <img style="border:0px;" id="imgdoc{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
			                                        </div>&nbsp;
			                                        <b>Documents</b>
			                                </div>
			                        </td>{/strip}
			                </tr>
			                <tr id="reldoc{$EVENTID}" bgcolor=white style=" display:none ">
			                    <td colspan="20">
			                        <div id="divdoc{$EVENTID}">
			                        </div>
			                    </td>
			                </tr>
			                {/if}
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;">
											<a href="javascript:showHideVTCallAddress({$quoteid},'MultiAddress','Billing','traddress{$quoteid}',divaddress{$quoteid},'imgaddress{$quoteid}');">
												<img style="border:0px;" id="imgaddress{$quoteid}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
										...
										{else}
											  <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;">
											<a href="javascript:showHideVTCallAddress({$quoteid},'MultiAddress','Project','traddress{$quoteid}',divaddress{$quoteid},'imgaddress{$quoteid}');">
												<img style="border:0px;" id="imgaddress{$quoteid}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                   ...
                                   <tr id="traddress{$quoteid}" bgcolor=white style=" display:none ">
                                    <td colspan="20">
                                        <div id="divaddress{$quoteid}">
                                        </div>
                                    </td>
                                  </tr>	
						{/if}
...
-->
                             ...
                             {foreach from=$RELATED_LIST key=rll item=rli}
                                 ...
                                 <tr>{strip}
                                         <td colspan=4 class="dvInnerHeader2">
                                         <div style="float:left;font-weight:bold;">
                                             <div style="float:left;"> <a href="javascript:showHideDetailViewRelatedList('{$RELCONTACT}','{$EVENTID}','{$quoteid}','MultiAddress','rel{$rli}{$EVENTID}','img{$rli}{$EVENTID}','div{$rli}{$EVENTID}','{$rli}')">
