...
<tr>
    ...
    <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
	    ...
	    <div align=center>
			...
			<tr>
				<td rowspan="2" valign="top" width="50"><img src="{'shareaccess.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MODULE_MANAGER}" title="{$MOD.LBL_MODULE_MANAGER}" border="0" height="48" width="48"></td>
			...
			<tr>
				...
				<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
					<tr>
						...
						{if $MAPSALESORDER_MODE neq 'edit'}
						<td class="small" align=right>
							<input class="crmButton small edit" title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" onclick="this.form.action.value='CustomerMapAccount';this.form.mapsalesorder_mode.value='edit'" type="submit" name="Edit" value="{$APP.LBL_EDIT_BUTTON_LABEL}">
						</td>
						{else}
						<td class="small" align=right>
					...
					<table border=0 cellspacing=0 cellpadding=0 width=100%>
						...
						<tr>
							<td align="center">
								<table border=0 cellspacing=0 cellpadding=0 width=100%>
									<tr>
										<td class="small" valign=top align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Map VTiger Sales Orders to Quickbooks Invoices <input type="radio" value="invoice" name="raObjectMap" {if $OBJECT_MAP eq 'invoice'} checked {else} disabled {/if}></td>
										<td class="small" valign=top align="center">&nbsp;&nbsp;&nbsp;&nbsp;Map VTiger Sales Orders to Quickbooks Sales Orders <input type="radio" value="saleorder" name="raObjectMap" {if $OBJECT_MAP eq 'saleorder'} checked {else} disabled {/if}></td>
										<td class="small" valign=top align="center">Map VTiger Sales Orders to Quickbooks Sales Receipts <input type="radio" value="salereceipt" name="raObjectMap" {if $OBJECT_MAP eq 'salereceipt'} checked {else} disabled {/if}></td>
									</tr>
								</table>
							</td>
						</tr>
					...
					<table border=0 cellspacing=0 cellpadding=0 width=100%>
						...
						<tr>
							<td align="center">
								<table border=0 cellspacing=0 cellpadding=0 width=100%>
									<tr>
										<td class="small" valign=top align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Map VTiger Sales Orders to Quickbooks Invoices <input type="radio" value="invoice" name="raObjectMap" {if $OBJECT_MAP eq 'invoice'} checked {/if}></td>
										<td class="small" valign=top align="center">&nbsp;&nbsp;&nbsp;&nbsp;Map VTiger Sales Orders to Quickbooks Sales Orders <input type="radio" value="saleorder" name="raObjectMap" {if $OBJECT_MAP eq 'saleorder'} checked {/if}></td>
										<td class="small" valign=top align="center">Map VTiger Sales Orders to Quickbooks Sales Receipts <input type="radio" value="salereceipt" name="raObjectMap" {if $OBJECT_MAP eq 'salereceipt'} checked {/if}></td>
									</tr>
								</table>
							</td>
						</tr>
					...
					<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
						 ...
						 */-->
                          ...
                          <tr valign="top">
                            ...
                            <td nowrap class="small cellText"><b>{$receipt_payment_method}</b></td>
                          </tr>
                          <tr valign="top">
                            ...
                            <td nowrap class="small cellText"><b>{$receipt_rep}</b></td>
                          </tr>
                          <tr valign="top">
                          	<td nowrap class="small cellLabel"><strong>Memo</strong></td>
                            ...
                            <td nowrap class="small cellText"><b>{$receipt_ship_via}</b></td>
                          </tr>
                          <tr valign="top">
                          	<td nowrap class="small cellLabel"><strong>Customer Message</strong></td>
                            ...
                            <td nowrap class="small cellText"><b>{$receipt_fob}</b></td>
                          </tr>
                          <tr valign="top">
                            ...
                            <td nowrap class="small cellText"><b>{$receipt_other}</b></td>
                          </tr>
                          </table>
			  {else}
