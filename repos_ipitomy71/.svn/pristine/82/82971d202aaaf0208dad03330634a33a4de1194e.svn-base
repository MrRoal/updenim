<?php /* Smarty version 2.6.18, created on 2014-04-14 12:57:27
         compiled from modules/VTCall/VTCallAccountDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'modules/VTCall/VTCallAccountDetailView.tpl', 295, false),array('modifier', 'vtiger_imageurl', 'modules/VTCall/VTCallAccountDetailView.tpl', 297, false),array('modifier', 'strip_tags', 'modules/VTCall/VTCallAccountDetailView.tpl', 360, false),array('modifier', 'regex_replace', 'modules/VTCall/VTCallAccountDetailView.tpl', 362, false),)), $this); ?>
...
?>
	...
	<?php if ($this->_tpl_vars['header'] == 'Account Information'): ?>
...
?>
							   ...
							   <?php $this->assign('keyadminToGo', $this->_tpl_vars['data']['isadmin']); ?>
                                   ...
                                   <?php endforeach; endif; unset($_from); ?>
                                                      ...
                                                      <!--if $nth eq 1  and $descSet eq 'No'
                                                        ...
                                                        if isset($keyfldnameDescription) and $descSet eq "No" and $keyfldname eq 'email1'
                                                            ...
                                                            <table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
                                                            <tr style="height:25px">
                                                            <td class="dvtCellLabel" align=right width=50%><input type="hidden" id="hdtxt_IsAdmin" value=<?php echo $this->_tpl_vars['keyadminToGo']; ?>
></input>Description</td>
                                                            <td width=50% class="dvtCellInfo" align="left" id="mouseArea_Description"><?php echo $this->_tpl_vars['keyfldnameDescription']; ?>
</td>
                                                            </tr>
                                                            </table>
                                                            </td>
...
">
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr><?php echo '<td colspan=4 class="dvInnerHeader3"><div style="float:left;font-weight:bold;"><div style="float:left;"><a href="javascript:showHideDetailViewEmailHistory(\'emailhistory'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'imgeh'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['accountid']; ?><?php echo '\',\'diveh'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'Accounts\')"><img style="border:0px;" id="imgeh'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a></div><b>&nbsp;'; ?><?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_HISTORY']; ?><?php echo '</b></div></td>'; ?>
...
">
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr><?php echo '<td colspan=4 class="dvInnerHeader4"><div style="float:left;font-weight:bold;"><div style="float:left;"><a href="javascript:showHideDetailViewPendingActivities(\'contactpendingactivities'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'imgcpa'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['accountid']; ?><?php echo '\',\'divcpa'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'Accounts\')"><img style="border:0px;" id="imgcpa'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a></div><b>&nbsp;'; ?><?php echo $this->_tpl_vars['MOD']['LBL_ACCOUNT_PENDING_ACTIVITIES']; ?><?php echo '</b></div></td>'; ?>
...
">
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr><?php echo '<td colspan=4 class="dvInnerHeader4"><div style="float:left;font-weight:bold;"><div style="float:left;"><a href="javascript:showHideDetailViewActivityHistory(\'contactactivityhistory'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'imgcah'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['accountid']; ?><?php echo '\',\'divcah'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'Accounts\')"><img style="border:0px;" id="imgcah'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a></div><b>&nbsp;'; ?><?php echo $this->_tpl_vars['MOD']['LBL_ACCOUNT_ACTIVITY_HISTORY']; ?><?php echo '</b></div></td>'; ?>
...
">
				...
				<?php if ($this->_tpl_vars['related_opportunities'] == 1): ?>
					<tr><?php echo '<td colspan=4 class="dvInnerHeader4"><div style="float:left;font-weight:bold"><div style="float:left"><a href="javascript:showHideDetailViewPotentialsRelatedList(\'relPotential'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'imgPt'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['accountid']; ?><?php echo '\',\'divPt'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'Accounts\')"><img style="border:0px;" id="imgPt'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a></div>&nbsp;<b>'; ?><?php echo $this->_tpl_vars['MOD']['LBL_RELATED_POTENTIALS']; ?><?php echo '</b></div></td>'; ?>

					</tr>
	                                <tr id="relPotential<?php echo $this->_tpl_vars['EVENTID']; ?>
" bgcolor=white style=" display:none ">
                                	    <td colspan="20">
                        	                <div id="divPt<?php echo $this->_tpl_vars['EVENTID']; ?>
">
                	                        </div>
        	                            </td>
	                                </tr>
				<?php endif; ?>
				<tr height='5px'><td>&nbsp;</td></tr>
				<?php if ($this->_tpl_vars['related_quotes'] == 1): ?>
                    <tr><?php echo '<td colspan=4 class="dvInnerHeader4"><div style="float:left;font-weight:bold"><div style="float:left"><a href="javascript:showHideDetailViewQuotesRelatedList(\'relQuote'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'imgq'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['contactid']; ?><?php echo '\',\'divq'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'Accounts\')"><img style="border:0px;" id="imgq'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a></div>&nbsp;<b> Related '; ?><?php echo $this->_tpl_vars['APP']['Quotes']; ?><?php echo '</b></div></td>'; ?>

                </tr>
                <tr id="relQuote<?php echo $this->_tpl_vars['EVENTID']; ?>
" bgcolor=white style=" display:none ">
                    <td colspan="20">
                        <div id="divq<?php echo $this->_tpl_vars['EVENTID']; ?>
">
                        </div>
                    </td>
                </tr>
                <?php endif; ?>
                <tr height='5px'><td>&nbsp;</td></tr>
				<?php if ($this->_tpl_vars['related_wos'] == 1): ?>
                    <tr><?php echo '<td colspan=4 class="dvInnerHeader4"><div style="float:left;font-weight:bold"><div style="float:left"><a href="javascript:showHideDetailViewSORelatedList(\'relSO'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'imgSO'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\''; ?><?php echo $this->_tpl_vars['contactid']; ?><?php echo '\',\'divSO'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '\',\'Accounts\')"><img style="border:0px;" id="imgSO'; ?><?php echo $this->_tpl_vars['EVENTID']; ?><?php echo '" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a></div>&nbsp;<b> Related '; ?><?php echo $this->_tpl_vars['APP']['SalesOrder']; ?><?php echo '</b></div></td>'; ?>

                </tr>
                <tr id="relSO<?php echo $this->_tpl_vars['EVENTID']; ?>
" bgcolor=white style=" display:none ">
                    <td colspan="20">
                        <div id="divSO<?php echo $this->_tpl_vars['EVENTID']; ?>
">
                        </div>
                    </td>
                </tr>
