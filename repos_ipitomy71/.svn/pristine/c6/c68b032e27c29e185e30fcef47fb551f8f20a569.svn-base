<?php /* Smarty version 2.6.18, created on 2014-03-18 20:32:18
...
">                								
												<option value="1.4" <?php if ($this->_tpl_vars['ASTERISK_VERSION'] == '1.4'): ?> selected <?php endif; ?>>1.4</option>
												<option value="1.6" <?php if ($this->_tpl_vars['ASTERISK_VERSION'] == '1.6'): ?> selected <?php endif; ?>>1.6</option>
                							</select>
										</td>
									</tr>
									<tr>
