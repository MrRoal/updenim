                    ...
                    <tr>
                        ...
                        {if $PRODUCT_VIEWABLE}
                            <td>
                                ...
                                <button id="Invoice_Btn_addsn" data-rel="{$INDEX}" data-id="{$LINE_ITEM_DETAIL["hdnProductId$INDEX"]}" type="button" class="btn addButton btn-default module-buttons Invoice_Btn_addsn" ><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;Add S/N</button>
                                {/if}
                            </td>
                        {/if}
