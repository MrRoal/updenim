<?php /* Smarty version 2.6.18, created on 2014-04-22 02:19:31
         compiled from modules/QuickBooks/QuickBooks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/QuickBooks/QuickBooks.tpl', 19, false),)), $this); ?>
    ...
    <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
	    ...
	    <div align=center>			
	    	...
	    	<tr>
	    		<td valign="bottom">
	    			<table><tr>
	    				<td><span style="font-weight: bold;">Last Sync Date</span>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction" name="date_transaction" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="<?php echo $this->_tpl_vars['LAST_SYNC_DATE']; ?>
" readonly>
	    				</td>	    				
						<td><span style="font-weight: bold;">Last Sync Time</span>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction" name="date_transaction" style=" width:65px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="<?php echo $this->_tpl_vars['LAST_SYNC_TIME']; ?>
" readonly>
	    				</td>
				...
				<td align="right"><span style="color:red;font-weight: bold;font-size: 12px;">Version <?php echo $this->_tpl_vars['VERSION']; ?>
</span></td>
			</tr>
			</table>
			<br>
				...
				<td class="settingsIconDisplay small">
					<table width="100%" cellspacing="0" cellpadding="10" border="0">
						...
						<tr>
							...
							<td valign="top">
							<?php if ($this->_tpl_vars['EnabledWebconnectorMonitor'] == 1): ?>
							<table width="100%" cellspacing="0" cellpadding="5" border="0">
								<tr>
									<td valign="top" rowspan="2" width="48px">
