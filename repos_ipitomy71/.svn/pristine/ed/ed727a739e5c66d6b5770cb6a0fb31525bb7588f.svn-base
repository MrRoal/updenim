<?php /* Smarty version 2.6.18, created on 2014-05-01 13:42:46
         compiled from modules/QuickBooks/ProductServiceFieldMapping.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/QuickBooks/ProductServiceFieldMapping.tpl', 18, false),)), $this); ?>
...
" border="0" height="48" width="48"></td>
				<td class="heading2" valign="bottom"><b><a href="index.php?module=QuickBooks&action=index&parenttab=Tools">Boru VT-QB</a> &gt; Products and Services</b></td>
			</tr>
			<tr>
				<td class="small" valign="top">Mapping VTiger Products and Services to Quickbooks</td>
			</tr>
			</table>
			<br><br>
			...
			<?php else: ?>-->
				<form action="index.php?module=QuickBooks&action=ProductServiceFieldMapping&parenttab=Tools" id="formPGC" method="POST" name="formPGC">
				Type&nbsp;
...
" id="field_count" name="field_count">
				<div id="list_fields" style="padding-top:10px;">
					...
					<?php endif; ?>
					<input type="radio" name="SyncQBItem2VT" value="all" <?php if ($this->_tpl_vars['SYNCQBITEM2VT'] == 'all'): ?>checked=""<?php endif; ?>> Sync all data from QB->VT ?
					<br/><input type="radio" name="SyncQBItem2VT" value="newly_modified" <?php if ($this->_tpl_vars['SYNCQBITEM2VT'] != 'all'): ?>checked=""<?php endif; ?>> Sync newly modified ones (based on latest modified time of records in QB) ?
				</div>
				<br>
...
//	    new_obj.style.paddingTop = '1px';
	...
	function selectGateway(gateway) {
	    window.location = "index.php?module=QuickBooks&action=ProductServiceFieldMapping&parenttab=Tools&gateway=" + gateway;
	}
</script>