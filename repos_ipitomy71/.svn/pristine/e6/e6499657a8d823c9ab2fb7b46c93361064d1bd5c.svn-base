<?php /* Smarty version 2.6.18, created on 2014-04-22 03:34:28
         compiled from modules/QuickBooks/TranferHistory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/QuickBooks/TranferHistory.tpl', 19, false),)), $this); ?>
<script language="JavaScript" type="text/javascript" src="modules/QuickBooks/QuickBooks.js"></script>
<div id="TranferHistoryListViewContents">
...
"></td>
    <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">		
	    ...
	    <div align=center>		
			...
			<tr>
				<td rowspan="2" valign="top" width="50"><img src="<?php echo vtiger_imageurl('audit.gif', $this->_tpl_vars['THEME']); ?>
...
" border="0" height="48" width="48"></td>
				<td class="heading2" valign="bottom"><b><a href="index.php?module=QuickBooks&action=index&parenttab=Tools">Boru VT-QB</a> &gt; Transfer History</b></td>
			</tr>

			<tr>
				<td class="small" valign="top">Display all records transferred</td>
			</tr>
			</table>
...
<script>	
	function navigatePage(page, offset) {
		...
		var data = "module=QuickBooks&action=QuickBooksAjax&file=TranferHistory&parenttab=Tools&page="+page;
			...
			\'index.php\',
				{
					...
					onComplete: function(response) {
						document.getElementById(\'TranferHistoryListViewContents\').innerHTML = response.responseText;
