<?php /* Smarty version Smarty-3.1.7, created on 2018-10-09 20:12:21
         compiled from "/home/ilogix/Workspace/BoruClientCRM/repos_ipitomy71/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:473894785bbc7af8320916-96816000%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8dde0e7083dcf1055b808476ddd77e51698227a8' => 
    array (
      0 => '/home/ilogix/Workspace/BoruClientCRM/repos_ipitomy71/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsContent.tpl',
      1 => 1539096138,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '473894785bbc7af8320916-96816000',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5bbc7af8970c4',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
<?php if ($_valid && !is_callable('content_5bbc7af8970c4')) {function content_5bbc7af8970c4($_smarty_tpl) {?>
...
</textarea></div><?php }?><?php }?><button type="button" class="btn btn-default" id="addSN" >&nbsp;&nbsp;<strong>Add SN</strong></button><div class="AddSN validCheck hide" id="discount_div0"><input type="hidden" id="discount_type0" name="discount_type0" value="zero" class="discount_type"><p class="popover_title">Serial Number</p><table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupTable"><tbody><tr><td><input type="text" value="123456789" id="serial_number113" name="serial_number113" size="20" class="small"></td><td><a href="javascript:void(0);" onclick="editSNS('113');">save</a> | <a href="javascript:void(0);" onclick="delSNS('113','2');">del</a></td></tr><tr><td colspan="2" class="lineOnTop"><textarea rows="5" cols="20" onblur="this.className='detailedViewTextBox'" name="serialnumbers2" id="serialnumbers2" onfocus="this.className='detailedViewTextBoxOn'" tabindex="" class="detailedViewTextBox"></textarea></td></tr></tbody></table></div></td><?php }?><td><input id="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
