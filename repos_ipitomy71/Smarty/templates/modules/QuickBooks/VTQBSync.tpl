			...
			<tbody><tr>
				<td style="font-size:13px;">
					...
					<p>
						...
						<td>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction" name="date_transaction" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="{$DATE_TRANSACTION}" readonly></td>
	    				<td><img src="{'btnL3Calendar.gif'|@vtiger_imageurl:$THEME}" id="image_date_transaction"></td></tr></table>
						...
						<td style="display:none">&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction_item" name="date_transaction_item" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="{$DATE_TRANSACTION_ITEM}" readonly></td>
	    				<td style="display:none"><img src="{'btnL3Calendar.gif'|@vtiger_imageurl:$THEME}" id="image_date_transaction_item"></td></tr></table>
						<script language="javascript">
							Calendar.setup (
						    	{ldelim}
						...
						<td>&nbsp;&nbsp;<span style="color:red;font-weight:bold;">Import Date</span></td>
						<td>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction_other" name="date_transaction_other" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="{$DATE_TRANSACTION_OTHER}" readonly></td>
	    				<td><img src="{'btnL3Calendar.gif'|@vtiger_imageurl:$THEME}" id="image_date_transaction_other"></td></tr></table>
						<script language="javascript">
							Calendar.setup (
						    	{ldelim}
						...
						<td>&nbsp;&nbsp;<span style="color:red;font-weight:bold;">Import Date</span></td>
						<td>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction_payment" name="date_transaction_payment" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="{$DATE_TRANSACTION_PAYMENT}" readonly></td>
	    				<td><img src="{'btnL3Calendar.gif'|@vtiger_imageurl:$THEME}" id="image_date_transaction_payment"></td></tr></table>
						<script language="javascript">
							Calendar.setup (
						    	{ldelim}
						...
						<td>&nbsp;&nbsp;<span style="color:red;font-weight:bold;">Import Date</span></td>
						<td>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction_vendor" name="date_transaction_vendor" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="{$DATE_TRANSACTION_VENDOR}" readonly></td>
	    				<td><img src="{'btnL3Calendar.gif'|@vtiger_imageurl:$THEME}" id="image_date_transaction_vendor"></td></tr></table>
						<script language="javascript">
							Calendar.setup (
						    	{ldelim}
						...
						<td>&nbsp;&nbsp;<span style="color:red;font-weight:bold;">Import Date</span></td>
						<td>&nbsp;<input maxlength=10 type="text" class="txtBox" id="date_transaction_po" name="date_transaction_po" style=" width:80px;font-size: 14px;" onkeypress="CheckKeyValue(event);" value="{$DATE_TRANSACTION_PO}" readonly></td>
	    				<td><img src="{'btnL3Calendar.gif'|@vtiger_imageurl:$THEME}" id="image_date_transaction_po"></td></tr></table>
						<script language="javascript">
							Calendar.setup (
						    	{ldelim}
