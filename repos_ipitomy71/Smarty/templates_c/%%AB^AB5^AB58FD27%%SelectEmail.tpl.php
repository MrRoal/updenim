<?php /* Smarty version 2.6.18, created on 2014-03-19 01:55:37
         compiled from SelectEmail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'SelectEmail.tpl', 27, false),)), $this); ?>
<!-- BEGIN: main -->
<div id="roleLay" style="z-index:12;display:block;width:400px;" class="layerPopup">
	<input name="excludedRecords" type="hidden" id="excludedRecords" value="<?php echo $this->_tpl_vars['EXE_REC']; ?>
">
	<input name='search_url' id="search_url" type='hidden' value='<?php echo $this->_tpl_vars['SEARCH_URL']; ?>
'>
	<input name='viewid' id="viewid" type='hidden' value='<?php echo $this->_tpl_vars['VIEWID']; ?>
'>
