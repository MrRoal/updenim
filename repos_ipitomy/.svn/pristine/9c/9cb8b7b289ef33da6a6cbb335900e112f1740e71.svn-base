<?php /* Smarty version 2.6.18, created on 2014-04-14 12:55:27
         compiled from modules/VTCall/CustomView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/VTCall/CustomView.tpl', 114, false),)), $this); ?>
<!--*********************************************************************************
...
<input type="hidden" name="module" value="VTCall">
<input type="hidden" name="action" value="SaveCustomView">
...
"></td>
  <td class="showPanelBg" valign="top" width="100%">
   <div class="small" style="padding: 20px;">
	<span class="lvtHeaderText"><a class="hdrLink" href="index.php?action=index&module=VTCall&parenttab=<?php echo $this->_tpl_vars['CATEGORY']; ?>
">VT Call</a> &gt;
