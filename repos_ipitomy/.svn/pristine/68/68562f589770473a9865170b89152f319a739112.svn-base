<?php /* Smarty version 2.6.18, created on 2014-03-18 20:46:20
         compiled from DocumentsListViewEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'DocumentsListViewEntries.tpl', 115, false),array('modifier', 'count', 'DocumentsListViewEntries.tpl', 137, false),array('function', 'html_options', 'DocumentsListViewEntries.tpl', 320, false),)), $this); ?>
...
' class="documentModuleFolderView">
										<input type="hidden" name="numOfRows" id="numOfRows_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" value="">
										<input type="hidden" name="folderidVal" id="folderid_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" value="<?php echo $this->_tpl_vars['folder']['folderid']; ?>
">
										<input type="hidden" name="selectedboxes" id="selectedboxes_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" value="">
										<input type="hidden" name="excludedRecords" id="excludedRecords_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" value="">
                                        <table class="reportsListTable" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
                                                ...
                                                <td class="mailSubHeader small" align="center" nowrap><?php echo $this->_tpl_vars['folder']['recordListRange']; ?>
</td>
...
" id="currentPageRec_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
...
?>
																...
																<tr>
																	<td id="linkForSelectAll_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" class="linkForSelectAll" style="display:none;" colspan=10>
																		<span id="selectAllRec_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" class="selectall" style="display:inline;" onClick="toggleSelectDocumentRecords('<?php echo $this->_tpl_vars['MODULE']; ?>
',true,'selected_id<?php echo $this->_tpl_vars['folder']['folderid']; ?>
','selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
')"><?php echo $this->_tpl_vars['APP']['LBL_SELECT_ALL']; ?>
 <span class="folder" id="count_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
"> </span> <?php echo $this->_tpl_vars['APP']['LBL_RECORDS_IN']; ?>
 <span class="folder"><?php echo $this->_tpl_vars['folder']['foldername']; ?>
</span> <?php echo $this->_tpl_vars['APP']['LBL_FOLDER']; ?>
</span>
																		<span id="deSelectAllRec_selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
" class="selectall" style="display:none;" onClick="toggleSelectDocumentRecords('<?php echo $this->_tpl_vars['MODULE']; ?>
',false,'selected_id<?php echo $this->_tpl_vars['folder']['folderid']; ?>
','selectall<?php echo $this->_tpl_vars['folder']['folderid']; ?>
')"><?php echo $this->_tpl_vars['APP']['LBL_DESELECT_ALL']; ?>
 <span class="folder"><?php echo $this->_tpl_vars['folder']['foldername']; ?>
</span> <?php echo $this->_tpl_vars['APP']['LBL_FOLDER']; ?>
</span>
																	</td>
