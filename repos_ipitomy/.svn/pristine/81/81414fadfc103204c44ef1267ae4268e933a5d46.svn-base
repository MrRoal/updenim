                ...
                <tr>
					...
					<!-- Command Buttons -->
				  	<table border=0 cellspacing=0 cellpadding=0 width=100%>
						...
						{*{if $header eq 'Sales Order Information'}*}
 
						     <tr>{strip}
						     <td colspan=4 class="dvInnerHeader">
							
							<div style="float:left;font-weight:bold;"><div style="float:left;"><a href="javascript:showHideDetailViewVTCallQuotesWO('dtlViewWO{$contactid}','imgWO{$contactid}');">
							...
							<tr height="5px"><td>&nbsp;</td></tr>	
                                 ...
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader2">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"> <a href="javascript:showHideDetailViewQuotesContacts('{$RELCONTACT}','{$EVENTID}','{$salesorderid}','SalesOrder','relSOCon{$EVENTID}','imgSOCon{$EVENTID}','divSOCon{$EVENTID}')">
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a onclick="javascript:showHideDetailViewActivitiesList('activitydetailsso{$EVENTID}','imgaso{$EVENTID}','{$EVENTID}','{$salesorderid}','divso{$EVENTID}','{$DATEFORMAT_VTCALL}')" name="{$EVENTID}" href="#{$EVENTID}"><img style="border:0px;" id="imgaso{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewActivityHistory('qActhistory{$EVENTID}','imgcah{$EVENTID}','{$EVENTID}','{$salesorderid}','qdiveh{$EVENTID}','SalesOrder')">
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewEmailHistory('emailhistory{$EVENTID}','imgeh{$EVENTID}','{$EVENTID}','{$salesorderid}','diveh{$EVENTID}','SalesOrder')"><img style="border:0px;" id="imgeh{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                 ...
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
											...
											<a href="javascript:showHideVTCallAddress({$salesorderid},'SalesOrder','Billing','traddress{$salesorderid}',divaddress{$salesorderid},'imgaddress{$salesorderid}');">
												<img style="border:0px;" id="imgaddress{$salesorderid}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
										...
										{else}
											  <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;">
											<a href="javascript:showHideVTCallAddress({$salesorderid},'SalesOrder','Project','traddress{$salesorderid}',divaddress{$salesorderid},'imgaddress{$salesorderid}');">
												<img style="border:0px;" id="imgaddress{$salesorderid}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                   ...
                                   <tr id="traddress{$salesorderid}" bgcolor=white style=" display:none ">
                                    <td colspan="20">
                                        <div id="divaddress{$salesorderid}">
                                        </div>
                                    </td>
                                  </tr>	
						{/if}	
...
-->
                             ...
                             {foreach from=$RELATED_LIST key=rll item=rli}
                                 ...
                                 <tr>{strip}
                                         <td colspan=4 class="dvInnerHeader2">
                                         <div style="float:left;font-weight:bold;">
                                             <div style="float:left;"> <a href="javascript:showHideDetailViewRelatedList('{$RELCONTACT}','{$EVENTID}','{$salesorderid}','SalesOrder','rel{$rli}{$EVENTID}','img{$rli}{$EVENTID}','div{$rli}{$EVENTID}','{$rli}')">
