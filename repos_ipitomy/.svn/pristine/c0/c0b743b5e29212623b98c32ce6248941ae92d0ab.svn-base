	    ...
	    <div align="left" style="padding: 20px;">
			...
			{else}-->
				...
				<div id="list_fields" style="padding-top:10px;">
					...
					{/if}
					<input type="radio" name="SyncQBItem2VT" value="all" {if $SYNCQBITEM2VT eq 'all'}checked=""{/if}> Sync all data from QB->VT ?
					<br/><input type="radio" name="SyncQBItem2VT" value="newly_modified" {if $SYNCQBITEM2VT neq 'all'}checked=""{/if}> Sync newly modified ones (based on latest modified time of records in QB) ?
				</div>
				<br>
