...
<tr>
    ...
    <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
	    ...
	    <div align=center>
			...
			<tr>
				<td rowspan="2" valign="top" width="50"><img src="{'audit.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MODULE_MANAGER}" title="{$MOD.LBL_MODULE_MANAGER}" border="0" height="48" width="48"></td>
			...
			<table width="95%" cellspacing="1" cellpadding="4" border="0" class="lvt small">
				...
				<tr bgcolor="white" id="row_{$val.module}" onmouseout="this.className='lvtColData'" onmouseover="this.className='lvtColDataHover'">
					...
					{if $i eq 'msg'}
						<td><textarea rows="8" cols="90" name="msg" tabindex="" class="detailedViewTextBox">{$val}</textarea></td>
					{else}
						<td>{$val}</td>
					{/if}
					{/foreach}
...
<script>
	function navigatePage(page, offset) {
		...
		var data = "module=QuickBooks&action=QuickBooksAjax&file=QBLogHistory&parenttab=Tools&page="+page;
