<?php /* Smarty version 2.6.18, created on 2014-03-19 01:50:58
         compiled from Settings/InventoryNotify.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Settings/InventoryNotify.tpl', 40, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
			...
			<tr>
				<td width="50" rowspan="2" valign="top"><img src="<?php echo vtiger_imageurl('inventory.gif', $this->_tpl_vars['THEME']); ?>
...
</a> > <?php echo $this->_tpl_vars['MOD']['INVENTORYNOTIFICATION']; ?>
 </b></td>
				<td rowspan=2 class="small" align=right>&nbsp;</td>
			</tr>
			<tr>
				<td valign=top class="small" align="left"><?php echo $this->_tpl_vars['MOD']['LBL_INV_NOTIF_DESCRIPTION']; ?>
</td>
			</tr>
			</table>
<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="0" class="listTableTopButtons">
                  <tr >
                    ...
                    <td  style="padding-left:5px;" class="big"><?php echo $this->_tpl_vars['MOD']['INVENTORYNOTIFICATION']; ?>
</td>
                    <td align="right">&nbsp;</td>
                  </tr>
			  </table>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'Settings/InventoryNotifyContents.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	</div>
