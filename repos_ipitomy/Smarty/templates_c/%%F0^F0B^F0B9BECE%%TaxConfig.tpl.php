<?php /* Smarty version 2.6.18, created on 2014-03-19 20:15:22
         compiled from Settings/TaxConfig.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Settings/TaxConfig.tpl', 33, false),array('modifier', 'cat', 'Settings/TaxConfig.tpl', 119, false),array('modifier', 'bin2hex', 'Settings/TaxConfig.tpl', 124, false),)), $this); ?>
...
?>
				...
				<td width=35% class="cellLabel small" >
					<?php if ($this->_tpl_vars['EDIT_MODE'] == 'true'): ?>
						<?php $this->assign('pstax', $this->_tpl_vars['tax']['taxlabel']); ?>
						<input name="<?php echo ((is_array($_tmp=$this->_tpl_vars['pstax'])) ? $this->_run_mod_handler('bin2hex', true, $_tmp) : bin2hex($_tmp)); ?>
...
?>
			...
			<td width=35% class="cellLabel small">
			 	<?php if ($this->_tpl_vars['SH_EDIT_MODE'] == 'true'): ?>
                    <?php $this->assign('shtax', $this->_tpl_vars['tax']['taxlabel']); ?>
					<input name="<?php echo ((is_array($_tmp=$this->_tpl_vars['shtax'])) ? $this->_run_mod_handler('bin2hex', true, $_tmp) : bin2hex($_tmp)); ?>
" id="<?php echo $this->_tpl_vars['tax_label']; ?>
" type="text" value="<?php echo $this->_tpl_vars['tax']['taxlabel']; ?>
" class="detailedViewTextBox small">
			 	<?php else: ?> 
