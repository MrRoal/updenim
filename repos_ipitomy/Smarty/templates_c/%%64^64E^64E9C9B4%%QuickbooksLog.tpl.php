<?php /* Smarty version 2.6.18, created on 2014-04-22 19:36:05
         compiled from modules/QuickBooks/QuickbooksLog.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'modules/QuickBooks/QuickbooksLog.tpl', 19, false),)), $this); ?>
...
" border="0" height="48" width="48"></td>
				<td class="heading2" valign="bottom"><b><a href="index.php?module=QuickBooks&action=index&parenttab=Tools">Boru VT-QB</a> &gt; Quickbooks Log</b></td>
			</tr>

			<tr>
				<td class="small" valign="top">All logs of transaction</td>
			</tr>
			</table>
			...
			<table width="95%" cellspacing="0" cellpadding="2" border="0" class="small">
			    <tr>				
		            ...
		            <td nowrap="" class="small" width="20%">Showing Records <?php echo $this->_tpl_vars['START']; ?>
...
<script>	
	function navigatePage(page, offset) {
		...
		var data = "module=QuickBooks&action=QuickBooksAjax&file=QuickbooksLog&parenttab=Tools&page="+page;
