<?php /* Smarty version 2.6.18, created on 2014-03-18 20:13:20
...
_selectall" id="<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_selectCurrentPageRec" onclick="rel_toggleSelect(this.checked,'<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
...
?>
	...
	<tr>
		<td id="<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_linkForSelectAll" class="linkForSelectAll" style="display:none;" colspan=10>
			<span id="<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_selectAllRec" class="selectall" style="display:inline;" onClick="rel_toggleSelectAll_Records('<?php echo $this->_tpl_vars['MODULE']; ?>
','<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
',true,'<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_selected_id')"><?php echo $this->_tpl_vars['APP']['LBL_SELECT_ALL']; ?>
 <span id=<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_count class="folder"> </span> <?php echo $this->_tpl_vars['APP']['LBL_RECORDS_IN']; ?>
 <?php echo getTranslatedString($this->_tpl_vars['RELATED_MODULE'], $this->_tpl_vars['RELATED_MODULE']); ?>
 <?php echo $this->_tpl_vars['APP']['LBL_RELATED_TO_THIS']; ?>
 <?php echo $this->_tpl_vars['APP']['SINGLE_Campaigns']; ?>
</span>
			<span id="<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_deSelectAllRec" class="selectall" style="display:none;" onClick="rel_toggleSelectAll_Records('<?php echo $this->_tpl_vars['MODULE']; ?>
','<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
',false,'<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_selected_id')"><?php echo $this->_tpl_vars['APP']['LBL_DESELECT_ALL']; ?>
 <?php echo getTranslatedString($this->_tpl_vars['RELATED_MODULE'], $this->_tpl_vars['RELATED_MODULE']); ?>
 <?php echo $this->_tpl_vars['APP']['LBL_RELATED_TO_THIS']; ?>
 <?php echo $this->_tpl_vars['APP']['SINGLE_Campaigns']; ?>
</span>
...
?>
		<tr bgcolor=white>
			...
			<td><input name="<?php echo $this->_tpl_vars['MODULE']; ?>
_<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
...
<?php if ($this->_tpl_vars['MODULE'] == 'Campaigns' && ( $this->_tpl_vars['RELATED_MODULE'] == 'Contacts' || $this->_tpl_vars['RELATED_MODULE'] == 'Leads' || $this->_tpl_vars['RELATED_MODULE'] == 'Accounts' ) && count($this->_tpl_vars['RELATEDLISTDATA']['entries']) > 0 && $this->_tpl_vars['RESET_COOKIE'] == 'true'): ?>
			<script type='text/javascript'>set_cookie('<?php echo $this->_tpl_vars['RELATED_MODULE']; ?>
_all', '');</script>
<?php endif; ?>