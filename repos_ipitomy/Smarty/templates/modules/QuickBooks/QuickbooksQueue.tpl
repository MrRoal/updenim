    ...
    <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">		
	    ...
	    <div align=center>	
			...
			<tr>
				...
				<td class="heading2" valign="bottom"><b><a href="index.php?module=QuickBooks&action=index&parenttab=Tools">Boru VT-QB</a> &gt; Quickbooks Queue</b></td>
			</tr>

			<tr>
				<td class="small" valign="top">All queues of system</td>
			</tr>
			</table>
...
<script>	
	function navigatePage(page, offset) {
		...
		var data = "module=QuickBooks&action=QuickBooksAjax&file=QuickbooksQueue&parenttab=Tools&page="+page;
