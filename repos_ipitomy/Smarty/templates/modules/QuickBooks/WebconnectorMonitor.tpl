    ...
    <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">		
	    ...
	    <div align=center>	
			...
			<tr>
				...
				<td class="heading2" valign="bottom"><b><a href="index.php?module=QuickBooks&action=index&parenttab=Tools">Boru VT-QB</a> &gt; Webconnector Monitor</b></td>
			</tr>

			<tr>
				<td class="small" valign="top">Display Webconnector Info</td>
			</tr>
			</table>
			<br>
			<form method="POST">
			<table border="0" cellpadding="5" cellspacing="0" width="95%">
			<tr>
				<td class="small" valign="top" width="20%">Last Communication with Webconnector</td><td><b>{$LAST_COMMUNICATION}</b></td>
			</tr>
			<tr>
				<td class="small" valign="top">Select days/hour to trigger email alert if the webconnector didn�t run</td>
				<td>
					<table cellpadding="0" cellspacing="0"><tr><td>
					<input type="text" name="trigger_email_alert_value" value="{$TRIGGER_EMAIL_ALERT_VALUE}" style="width:100px;">
					</td><td>
					<select name="trigger_email_alert_time" style="width:95px;margin-left:5px;">
						<option value="days" {if $TRIGGER_EMAIL_ALERT_TIME eq 'days'}selected{/if}>days</option>
						<option value="hours" {if $TRIGGER_EMAIL_ALERT_TIME eq 'hours'}selected{/if}>hours</option>						
					</select>
					</td></tr></table>
				</td>
			</tr>
			<tr>
				<td class="small" valign="top">Email alert</td>
				<td>
					<input type="text" name="trigger_email_alert" value="{$TRIGGER_EMAIL_ALERT}" style="width:200px;">
				</td>
			</tr>
			<tr>
				<td class="small" valign="top" colspan="2"><input type="submit" value="Save" name="button" class="crmButton small save" accesskey="S" title="Save" style="width:70px;"></td>				
			</tr>
			</table>				
			</form>
			<br>			
...
<script>	
	function navigatePage(page, offset) {
		...
		var data = "module=QuickBooks&action=QuickBooksAjax&file=WebconnectorMonitor&parenttab=Tools&page="+page;
