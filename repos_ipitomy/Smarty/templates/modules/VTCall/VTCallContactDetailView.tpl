...
<tr>
	...
	{if $header eq 'Contact Information'}
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewEmailHistory('emailhistory{$EVENTID}','imgeh{$EVENTID}','{$EVENTID}','{$contactid}','diveh{$EVENTID}','Contacts')"><img style="border:0px;" id="imgeh{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewPendingActivities('contactpendingactivities{$EVENTID}','imgcpa{$EVENTID}','{$EVENTID}','{$contactid}','divcpa{$EVENTID}','Contacts')"><img style="border:0px;" id="imgcpa{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                                    {$MOD.LBL_CONTACT_PENDING_ACTIVITIES}
                                                </b>
                                        </div>
                                     </td>{/strip}
                                 </tr>
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewActivityHistory('contactactivityhistory{$EVENTID}','imgcah{$EVENTID}','{$EVENTID}','{$contactid}','divcah{$EVENTID}','Contacts')"><img style="border:0px;" id="imgcah{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                                    {$MOD.LBL_CONTACT_ACTIVITY_HISTORY}
                                                </b>
                                        </div>
                                     </td>{/strip}
                                 </tr>
                                        ...
                                        <td colspan=4 class="dvInnerHeader4">
                                                <div style="float:left;font-weight:bold">
                                                        <div style="float:left">
                                                                <a href="javascript:showHideDetailViewPotentialsRelatedList('relPotential{$EVENTID}','imgPt{$EVENTID}','{$EVENTID}','{$contactid}','divPt{$EVENTID}','Contacts')">
							...
							{if $related_quotes eq 1}
                                <tr>{strip}
                                        <td colspan=4 class="dvInnerHeader4">
                                                <div style="float:left;font-weight:bold">
                                                        <div style="float:left">
                                                                <a href="javascript:showHideDetailViewQuotesRelatedList('relQuote{$EVENTID}','imgq{$EVENTID}','{$EVENTID}','{$contactid}','divq{$EVENTID}','Contacts')">
							...
							{if $related_wos eq 1}
			                    <tr>{strip}
			                        <td colspan=4 class="dvInnerHeader4">
			                                <div style="float:left;font-weight:bold">
			                                        <div style="float:left">
			                                                <a href="javascript:showHideDetailViewSORelatedList('relSO{$EVENTID}','imgSO{$EVENTID}','{$EVENTID}','{$contactid}','divSO{$EVENTID}','Contacts')">
			                ...
			                <!-- related list -->
                             {foreach from=$RELATED_LIST key=rll item=rli}
                                 ...
                                 <tr>{strip}
                                         <td colspan=4 class="dvInnerHeader2">
                                         <div style="float:left;font-weight:bold;">
                                             <div style="float:left;"> <a href="javascript:showHideDetailViewRelatedList('{$RELCONTACT}','{$EVENTID}','{$contactid}','Contacts','rel{$rli}{$EVENTID}','img{$rli}{$EVENTID}','div{$rli}{$EVENTID}','{$rli}')">
