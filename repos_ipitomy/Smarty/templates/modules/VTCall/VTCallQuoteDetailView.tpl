...
<tr>
	...
	{*{if $header eq 'Quote Information'}*}
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader2">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"> <a href="javascript:showHideDetailViewQuotesContacts('{$RELCONTACT}','{$EVENTID}','{$quoteid}','Quotes','relQCon{$EVENTID}','imgQCon{$EVENTID}','divQCon{$EVENTID}')">
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a onclick="javascript:showHideDetailViewActivitiesList('activitydetailsQ{$EVENTID}','imgq{$EVENTID}','{$EVENTID}','{$quoteid}','divq{$EVENTID}','{$DATEFORMAT_VTCALL}')" name="{$EVENTID}" href="#{$EVENTID}"><img style="border:0px;" id="imgq{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewActivityHistory('qActhistory{$EVENTID}','imgcah{$EVENTID}','{$EVENTID}','{$quoteid}','qdiveh{$EVENTID}','Quotes')">
							...
							<tr height="5px"><td>&nbsp;</td></tr>						   
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewEmailHistory('emailhistory{$EVENTID}','imgeh{$EVENTID}','{$EVENTID}','{$quoteid}','diveh{$EVENTID}','Quotes')"><img style="border:0px;" id="imgeh{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                 ...
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
											...
											<a href="javascript:showHideVTCallAddress({$quoteid},'Quotes','Billing','traddress{$quoteid}',divaddress{$quoteid},'imgaddress{$quoteid}');">
										...
										{else}
											  <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;">
											<a href="javascript:showHideVTCallAddress({$quoteid},'Quotes','Project','traddress{$quoteid}',divaddress{$quoteid},'imgaddress{$quoteid}');">
												<img style="border:0px;" id="imgaddress{$quoteid}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
...
-->
                             ...
                             {foreach from=$RELATED_LIST key=rll item=rli}
                                 ...
                                 <tr>{strip}
                                         <td colspan=4 class="dvInnerHeader2">
                                         <div style="float:left;font-weight:bold;">
                                             <div style="float:left;"> <a href="javascript:showHideDetailViewRelatedList('{$RELCONTACT}','{$EVENTID}','{$quoteid}','Quotes','rel{$rli}{$EVENTID}','img{$rli}{$EVENTID}','div{$rli}{$EVENTID}','{$rli}')">
