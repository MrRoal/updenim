                ...
                <tr>
					...
					<!-- Command Buttons -->
				  	<table border=0 cellspacing=0 cellpadding=0 width=100%>
							...
							{assign var=str_header value='SINGLE_Accounts'|@getTranslatedString:'Accounts'}
							{assign var=str_header value=$str_header|cat:' Information'}
							<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">

	{if $header eq 'Account Information'}
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader3">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewEmailHistory('emailhistory{$EVENTID}','imgeh{$EVENTID}','{$EVENTID}','{$accountid}','diveh{$EVENTID}','Accounts')"><img style="border:0px;" id="imgeh{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
                                        	<div style="float:left;"><a href="javascript:showHideDetailViewPendingActivities('contactpendingactivities{$EVENTID}','imgcpa{$EVENTID}','{$EVENTID}','{$accountid}','divcpa{$EVENTID}','Accounts')"><img style="border:0px;" id="imgcpa{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                                    {$MOD.LBL_ACCOUNT_PENDING_ACTIVITIES}
                                                </b>
                                        </div>
                                     </td>{/strip}
                                 </tr>
							...
							<tr height="5px"><td>&nbsp;</td></tr>
                                 <tr>{strip}
                                     <td colspan=4 class="dvInnerHeader4">
                                        ...
                                        <div style="float:left;font-weight:bold;">
<div style="float:left;"><a href="javascript:showHideDetailViewActivityHistory('contactactivityhistory{$EVENTID}','imgcah{$EVENTID}','{$EVENTID}','{$accountid}','divcah{$EVENTID}','Accounts')">
<img style="border:0px;" id="imgcah{$EVENTID}" alt="Display" title="Display" src="themes/images/inactivate.gif" /></a>
                                            </div><b>&nbsp;
                                                    {$MOD.LBL_ACCOUNT_ACTIVITY_HISTORY}
                                                </b>
                                        </div>
                                     </td>{/strip}
                                 </tr>
						...
						<td colspan=4 class="dvInnerHeader4">
							<div style="float:left;font-weight:bold">
								<div style="float:left">
									 <a href="javascript:showHideDetailViewPotentialsRelatedList('relPotential{$EVENTID}','imgPt{$EVENTID}','{$EVENTID}','{$accountid}','divPt{$EVENTID}','Accounts')">
				...
				{if $related_quotes eq 1}
                    <tr>{strip}
                        <td colspan=4 class="dvInnerHeader4">
                                <div style="float:left;font-weight:bold">
                                        <div style="float:left">
                                                <a href="javascript:showHideDetailViewQuotesRelatedList('relQuote{$EVENTID}','imgq{$EVENTID}','{$EVENTID}','{$contactid}','divq{$EVENTID}','Accounts')">
				...
				{if $related_wos eq 1}
                    <tr>{strip}
                        <td colspan=4 class="dvInnerHeader4">
                                <div style="float:left;font-weight:bold">
                                        <div style="float:left">
                                                <a href="javascript:showHideDetailViewSORelatedList('relSO{$EVENTID}','imgSO{$EVENTID}','{$EVENTID}','{$contactid}','divSO{$EVENTID}','Accounts')">
...
<!-- related list -->
                             {foreach from=$RELATED_LIST key=rll item=rli}
                                 ...
                                 <tr>{strip}
                                         <td colspan=4 class="dvInnerHeader2">
                                         <div style="float:left;font-weight:bold;">
                                             <div style="float:left;"> <a href="javascript:showHideDetailViewRelatedList('{$RELCONTACT}','{$EVENTID}','{$accountid}','Accounts','rel{$rli}{$EVENTID}','img{$rli}{$EVENTID}','div{$rli}{$EVENTID}','{$rli}')">
